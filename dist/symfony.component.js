...
var SymfonyComponent = (function () {
    function SymfonyComponent() {
        this.inicial = false;
        this.htmlExample = "<div [hidden]=\"estado()\">ola tudo bem</div>";
    }
    SymfonyComponent.prototype.onclicked = function (value) {
        this.inicial = value;
    };
    SymfonyComponent.prototype.estado = function () {
        return true;
    };
